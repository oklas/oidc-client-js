...
export class OidcClientSettings {
    constructor({
        // metadata related
        authority, metadataUrl, metadata, metadata_override, signingKeys,
        // client related
        ...
        this._metadata_override = metadata_override;
    ...
    get metadata_override() {
        return this._metadata_override;
    }
    set metadata_override(value) {
        this._metadata_override = value;
    }
